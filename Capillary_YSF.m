...
% k=0.7;              % viscosity at shear rate = 1 1/s [Pa s^n]
% n= 0.4;             % shear thinning power [1]
% Sy=1;               % yield stress [Pa]
% 
% sigma=0.063;        % surface tension [N/m]
% rho =1000.7;        % density [kg/m^3]
% theta_zero=75.5225; % equilibrium contact angle [degree]
% R=0.0085;           % capillary radius [m]
% alpha=5.46e-5;      % slip prefactor [vel/stress], proportional to slip length, l_s = alpha*mu 
% 
% X1=28.669;          % DCA constant for the early regime 
% X2=3.5;             % DCA constant for the later regime
